...
import './EtiquetaCRUD.css'; // Importa el archivo CSS para los estilos
...
const EtiquetaCRUD = ({ token }) => {
  ...
  return (
    <div className="bg-while text-dark min-vh-100 d-flex flex-column justify-content-center align-items-center">
      <Menu userInfo={userInfo} />

      <div className="mt-5 mx-3 mb-4 text-center">
        <h2 className="title">Gestión de Etiquetas</h2>
